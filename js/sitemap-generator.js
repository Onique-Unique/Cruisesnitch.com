...
if (link.hostname == domain && !link.href.includes('#') && !link.href.includes('contact-page') && !link.href.includes('disclaimer-policy-page')) {
    ...
    cruiseSitemapGen += '<url>\n<loc>' + linkHref + '</loc>\n<lastmod>' + new Date().toISOString() + '</lastmod>\n<priority>1.00</priority>\n</url>\n';
    linkHrefs.push(linkHref);
    }
}
}

cruiseSitemapGen += '</urlset>';

// Store sitemap data in local storage
localStorage.setItem('cruiseSitemapGen', cruiseSitemapGen);
